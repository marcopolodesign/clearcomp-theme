...
<div class="home-starter min-h-[60vh] flex column-mobile items-center container mt-[160px] py-20 pl-20 pr-0 bg-[var(<?php echo $colors; ?>)] rounded-[8px]">
    <div class="w-2/5 flex flex-col">       
        ...
        <p class=' text-[var(<?php echo $textColors;?>)] mb-5 text-xl'><?php the_sub_field('sub_parragraph');?></p>
         ...
         <?php if( $link ): ?>
            <a class="button btn btn-primary bg-[var(<?php echo $ctaColor; ?>)] self-start text-[var(<?php echo $textCTAColors; ?>)]" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
        <?php endif; ?>
...
<div class='flex column-mobile-reverse container justify-between items-start mt-[160px] px-20 py-32 bg-[var(<?php echo $colors; ?>)] rounded-[8px] rounded-tl-[100px] rounded-br-[100px] relative mx-auto'>
    ...
    <div class="absolute bottom-0 translate-y-8 right-20 w-[25%] border-[mainBorder] border-2 bg-white rounded-md px-10 py-6">
        <?php if ($landingIcon): ?>
